...
/// <summary>
/// Create an entity from the given <see cref="RequestEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(RequestBlueprintBehaviour))]
public class CreateEntityFromRequestBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private RequestBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<RequestBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Request.CreateEntity();
