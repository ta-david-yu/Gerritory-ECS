...
/// <see cref="TileEntity"/>.
/// </summary>
[CreateAssetMenu(fileName = "NewTileBlueprint", menuName = "EntitasRedux/Tile/TileBlueprint")]
public partial class TileBlueprint : BlueprintBase, ITileBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(TileEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = TileComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = TileComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
