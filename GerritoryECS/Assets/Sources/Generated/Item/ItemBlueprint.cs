...
/// <see cref="ItemEntity"/>.
/// </summary>
[CreateAssetMenu(fileName = "NewItemBlueprint", menuName = "EntitasRedux/Item/ItemBlueprint")]
public partial class ItemBlueprint : BlueprintBase, IItemBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(ItemEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = ItemComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = ItemComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
