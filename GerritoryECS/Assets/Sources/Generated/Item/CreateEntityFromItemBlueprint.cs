...
/// <summary>
/// Create an entity from the given <see cref="ItemEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(ItemBlueprintBehaviour))]
public class CreateEntityFromItemBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private ItemBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<ItemBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Item.CreateEntity();
