...
/// <summary>
/// Create an entity from the given <see cref="ElementEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(ElementBlueprintBehaviour))]
public class CreateEntityFromElementBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private ElementBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<ElementBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Element.CreateEntity();
