...
{
	public MoveOnTileAddedListenerComponent MoveOnTileAddedListener { get { return (MoveOnTileAddedListenerComponent)GetComponent(ElementComponentsLookup.MoveOnTileAddedListener); } }
	public bool HasMoveOnTileAddedListener { get { return HasComponent(ElementComponentsLookup.MoveOnTileAddedListener); } }

	public void AddMoveOnTileAddedListener(System.Collections.Generic.List<IMoveOnTileAddedListener> newValue)
	{
		var index = ElementComponentsLookup.MoveOnTileAddedListener;
	...
	{
		RemoveComponent(ElementComponentsLookup.MoveOnTileAddedListener);
	}
}
...
{
	static JCMG.EntitasRedux.IMatcher<ElementEntity> _matcherMoveOnTileAddedListener;

	public static JCMG.EntitasRedux.IMatcher<ElementEntity> MoveOnTileAddedListener
	{
		get
		{
			if (_matcherMoveOnTileAddedListener == null)
			{
				var matcher = (JCMG.EntitasRedux.Matcher<ElementEntity>)JCMG.EntitasRedux.Matcher<ElementEntity>.AllOf(ElementComponentsLookup.MoveOnTileAddedListener);
