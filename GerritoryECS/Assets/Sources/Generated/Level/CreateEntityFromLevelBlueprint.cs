...
/// <summary>
/// Create an entity from the given <see cref="LevelEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(LevelBlueprintBehaviour))]
public class CreateEntityFromLevelBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private LevelBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<LevelBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Level.CreateEntity();
