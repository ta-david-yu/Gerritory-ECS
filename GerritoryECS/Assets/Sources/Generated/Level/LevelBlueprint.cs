...
/// </summary>
[CreateAssetMenu(fileName = "NewLevelBlueprint", menuName = "EntitasRedux/Level/LevelBlueprint")]
public partial class LevelBlueprint : BlueprintBase, ILevelBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(LevelEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = LevelComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = LevelComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
