...
/// <summary>
/// Create an entity from the given <see cref="EffectEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(EffectBlueprintBehaviour))]
public class CreateEntityFromEffectBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private EffectBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<EffectBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Effect.CreateEntity();
