...
/// <summary>
/// Create an entity from the given <see cref="GameFlowEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(GameFlowBlueprintBehaviour))]
public class CreateEntityFromGameFlowBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private GameFlowBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<GameFlowBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.GameFlow.CreateEntity();
