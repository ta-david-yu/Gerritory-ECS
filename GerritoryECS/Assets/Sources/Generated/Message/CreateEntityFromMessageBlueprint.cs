...
/// <summary>
/// Create an entity from the given <see cref="MessageEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(MessageBlueprintBehaviour))]
public class CreateEntityFromMessageBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private MessageBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<MessageBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Message.CreateEntity();
