...
/// <summary>
/// Create an entity from the given <see cref="CommandEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(CommandBlueprintBehaviour))]
public class CreateEntityFromCommandBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private CommandBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<CommandBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Command.CreateEntity();
