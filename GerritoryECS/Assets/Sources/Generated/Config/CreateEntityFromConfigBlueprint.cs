...
/// <summary>
/// Create an entity from the given <see cref="ConfigEntity"/> blueprint component and link it to this gameObject
/// </summary>
[RequireComponent(typeof(ConfigBlueprintBehaviour))]
public class CreateEntityFromConfigBlueprint : MonoBehaviour
{
	[System.Serializable]
	...
	[SerializeField]
	private ConfigBlueprintBehaviour m_Blueprint;
	...
	private void OnValidate()
	{
		if (m_Blueprint == null)
		{
			m_Blueprint = GetComponent<ConfigBlueprintBehaviour>();
		}
	}
	...
	public void Execute()
	{
		...
		var entity = Contexts.SharedInstance.Config.CreateEntity();
